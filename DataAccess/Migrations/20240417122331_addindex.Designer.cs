...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240417122331_addindex")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Models.TransactionStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DataAccess.Models.Account", b =>
                {
                    b.HasOne("DataAccess.Models.Customer", "Owner")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("DataAccess.Models.Transaction", b =>
                {
                    b.HasOne("DataAccess.Models.TransactionStatus", "TransactionStatus")
                        .WithMany()
                        .HasForeignKey("TransactionStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccess.Models.Account", "RecipientAccount")
                        .WithMany("IncomingTransactions")
                        .HasForeignKey("RecipientAccountId", "RecipientAccountAccountNumber")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();

                    b.HasOne("DataAccess.Models.Account", "SenderAccount")
